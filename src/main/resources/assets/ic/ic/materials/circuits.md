...
navigation:
  title: Circuits
  icon: ic:advanced_circuit
  parent: materials/index.md
  position: 5
item_ids:
  - ic:electronic_circuit
  - ic:advanced_circuit
  - ic:iridium_circuit
---

# <Color id="gold">Circuits</Color>

<Column alignItems="center" fullWidth={true}>
  <ItemImage id="advanced_circuit" scale="2" />

  Circuits gate the tier of every machine you can craft. Each tier builds on the last.
</Column>
