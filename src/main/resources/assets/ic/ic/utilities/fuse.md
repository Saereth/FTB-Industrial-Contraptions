...
# <Color id="gold">Fuse</Color>

<Column alignItems="center" fullWidth={true}>
  <ItemImage id="fuse" scale="2" />

  A single-use repair charge for **burnt machines**. Right-click a burnt-out Industrial Contraptions machine with a fuse in hand to restore it.
</Column>
