...
<Column alignItems="center" fullWidth={true}>
  ...
  Every Industrial Contraptions machine runs on the same framework: an inventory, a recipe tick loop, an energy buffer, and up to four **upgrade** slots. Advanced variants are the same machine with larger buffers and higher throughput.
</Column>
