...
<Column alignItems="center" fullWidth={true}>
  ...
  Separates materials into their components. Extracts <ItemLink id="ic:silicon_gem" /> from quartz or sand, breaks down gravel and flint, and handles slime/magma processing.
</Column>
...
* Quartz or sand → <ItemLink id="ic:silicon_gem" />
* Gravel → flint
