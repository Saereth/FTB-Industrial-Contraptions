...
<Column alignItems="center" fullWidth={true}>
  ...
  The highest-output power source in the mod, and the most punishing mistake. A working reactor produces **hundreds to thousands of <EnergyUnit /> per tick**. A failing one **vaporizes your base**.
</Column>
...
* <Color id="gold">**Output**</Color>: <EnergyUnit /> per tick, multiplied by adjacent neutron reflectors and dual/quad rods.
