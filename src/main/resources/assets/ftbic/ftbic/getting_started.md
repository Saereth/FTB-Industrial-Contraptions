...
# <Color id="gold">Getting Started</Color>

<Column alignItems="center" fullWidth={true}>
  <ItemImage id="iron_furnace" scale="2" />

  Your entry into FTB Industrial Contraptions begins with rubber, copper, and your first machine block.
</Column>
...
Rubber is used for nearly every cable and machine in the mod.
...
<Row>
  <ItemImage id="iron_furnace" />
  ### <Color id="aqua">Iron Furnace</Color>
</Row>

<RecipeFor id="iron_furnace" />

Burns 1 coal for **12 items** (vs. vanilla's 8). A reliable first step while you gather copper and tin.
...
<Row>
  <ItemImage id="machine_block" />
  ### <Color id="aqua">Machine Block</Color>
</Row>

The empty shell used in the crafting recipe of every LV-tier machine.

<RecipeFor id="machine_block" />

<Row>
  <ItemImage id="electronic_circuit" />
  ### <Color id="aqua">Electronic Circuit</Color>
</Row>

Copper wire plus redstone on an iron plate. Required for nearly every LV-tier device.
