...
public class NuclearReactor {
	...
	public boolean tick() {
		...
		explosionRadius = ICConfig.NUCLEAR.NUCLEAR_REACTOR_EXPLOSION_BASE_RADIUS.get();
		...
		explosionRadius = Math.min(explosionRadius, ICConfig.NUCLEAR.NUCLEAR_REACTOR_EXPLOSION_LIMIT.get());
