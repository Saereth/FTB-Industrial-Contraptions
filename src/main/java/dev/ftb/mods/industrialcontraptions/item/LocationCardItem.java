...
public class LocationCardItem extends Item {
	...
	public InteractionResult use(Level level, Player player, InteractionHand hand) {
		...
		if (player.isCrouching() && !level.isClientSide()) {
			clear(stack);
			player.sendSystemMessage(Component.translatable("item.ic.location_card.cleared"));
		}
	...
	public InteractionResult useOn(UseOnContext ctx) {
		...
		if (boundDim != null && player instanceof ServerPlayer sp) {
			...
			if (id != null && bx != null && by != null && bz != null) {
				...
				player.sendSystemMessage(Component.translatable("item.ic.location_card.linked",
						name == null || name.isEmpty() ? Component.translatable("item.ic.location_card.unnamed") : Component.literal(name))
		...
		player.sendSystemMessage(Component.translatable("item.ic.location_card.bound",
				teleName.isEmpty() ? Component.translatable("item.ic.location_card.unnamed") : Component.literal(teleName))
	...
	public void appendHoverText(ItemStack stack, TooltipContext context, TooltipDisplay display,
		...
		if (dim == null) {
			tooltip.accept(Component.translatable("item.ic.location_card.unbound")
