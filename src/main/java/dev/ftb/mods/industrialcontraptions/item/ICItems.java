...
import dev.ftb.mods.industrialcontraptions.integration.guideme.ICGuideItem;
...
public interface ICItems {
	DeferredRegister.Items REGISTRY = DeferredRegister.createItems(IC.MOD_ID);
	...
	DeferredItem<BlockItem> RUBBER_SHEET = blockItem("rubber_sheet", ICBlocks.RUBBER_SHEET);
	DeferredItem<BlockItem> REINFORCED_STONE = blockItem("reinforced_stone", ICBlocks.REINFORCED_STONE);
	DeferredItem<BlockItem> REINFORCED_GLASS = blockItem("reinforced_glass", ICBlocks.REINFORCED_GLASS);
	DeferredItem<BlockItem> MACHINE_BLOCK = blockItem("machine_block", ICBlocks.MACHINE_BLOCK);
	DeferredItem<BlockItem> ADVANCED_MACHINE_BLOCK = blockItem("advanced_machine_block", ICBlocks.ADVANCED_MACHINE_BLOCK);
	DeferredItem<BlockItem> IRON_FURNACE = blockItem("iron_furnace", ICBlocks.IRON_FURNACE);
	DeferredItem<BlockItem> LV_CABLE = blockItem("lv_cable", ICBlocks.LV_CABLE);
	DeferredItem<BlockItem> MV_CABLE = blockItem("mv_cable", ICBlocks.MV_CABLE);
	DeferredItem<BlockItem> HV_CABLE = blockItem("hv_cable", ICBlocks.HV_CABLE);
	DeferredItem<BlockItem> EV_CABLE = blockItem("ev_cable", ICBlocks.EV_CABLE);
	DeferredItem<BlockItem> IV_CABLE = blockItem("iv_cable", ICBlocks.IV_CABLE);
	DeferredItem<BlockItem> BURNT_CABLE = blockItem("burnt_cable", ICBlocks.BURNT_CABLE);
	DeferredItem<BlockItem> LV_REINFORCED_CABLE = blockItem("lv_reinforced_cable", ICBlocks.LV_REINFORCED_CABLE);
	DeferredItem<BlockItem> MV_REINFORCED_CABLE = blockItem("mv_reinforced_cable", ICBlocks.MV_REINFORCED_CABLE);
	DeferredItem<BlockItem> HV_REINFORCED_CABLE = blockItem("hv_reinforced_cable", ICBlocks.HV_REINFORCED_CABLE);
	DeferredItem<BlockItem> EV_REINFORCED_CABLE = blockItem("ev_reinforced_cable", ICBlocks.EV_REINFORCED_CABLE);
	DeferredItem<BlockItem> IV_REINFORCED_CABLE = blockItem("iv_reinforced_cable", ICBlocks.IV_REINFORCED_CABLE);
	DeferredItem<BlockItem> BURNT_REINFORCED_CABLE = blockItem("burnt_reinforced_cable", ICBlocks.BURNT_REINFORCED_CABLE);
	DeferredItem<BlockItem> LANDMARK = blockItem("landmark", ICBlocks.LANDMARK);
	DeferredItem<BlockItem> EXFLUID = blockItem("exfluid", ICBlocks.EXFLUID);
	DeferredItem<BlockItem> NUCLEAR_REACTOR_CHAMBER = blockItem("nuclear_reactor_chamber", ICBlocks.NUCLEAR_REACTOR_CHAMBER);
	DeferredItem<BlockItem> NUKE = blockItem("nuke", ICBlocks.NUKE);
	DeferredItem<BlockItem> ACTIVE_NUKE = blockItem("active_nuke", ICBlocks.ACTIVE_NUKE);

	DeferredItem<ICGuideItem> GUIDE = REGISTRY.register("guide",
			name -> new ICGuideItem(props(name).stacksTo(1)));
	...
	DeferredItem<BlockItem> ENDERIUM_BLOCK = blockItem("enderium_block", ICBlocks.ENDERIUM_BLOCK);
	...
	DeferredItem<Item> SINGLE_USE_BATTERY = REGISTRY.register("single_use_battery",
			name -> new BatteryItem(props(name), BatteryType.SINGLE_USE, EnergyTier.LV, safeGet(ICConfig.ENERGY.SINGLE_USE_BATTERY_CAPACITY, 8_000D)));
	DeferredItem<Item> LV_BATTERY = REGISTRY.register("lv_battery",
			name -> new BatteryItem(props(name), BatteryType.RECHARGEABLE, EnergyTier.LV, safeGet(ICConfig.ENERGY.LV_BATTERY_CAPACITY, 10_000D)));
	DeferredItem<Item> MV_BATTERY = REGISTRY.register("mv_battery",
			name -> new BatteryItem(props(name), BatteryType.RECHARGEABLE, EnergyTier.MV, safeGet(ICConfig.ENERGY.MV_BATTERY_CAPACITY, 100_000D)));
	DeferredItem<Item> HV_BATTERY = REGISTRY.register("hv_battery",
			name -> new BatteryItem(props(name), BatteryType.RECHARGEABLE, EnergyTier.HV, safeGet(ICConfig.ENERGY.HV_BATTERY_CAPACITY, 1_000_000D)));
	DeferredItem<Item> EV_BATTERY = REGISTRY.register("ev_battery",
			name -> new BatteryItem(props(name), BatteryType.RECHARGEABLE, EnergyTier.EV, safeGet(ICConfig.ENERGY.EV_BATTERY_CAPACITY, 10_000_000D)));
