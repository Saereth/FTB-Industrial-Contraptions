...
import dev.ftb.mods.industrialcontraptions.material.MaterialEntry;
...
public class ICLootTableProvider extends LootTableProvider {
	public ICLootTableProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
