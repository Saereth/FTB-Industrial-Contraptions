...
public record AntimatterBoostRecipe(Ingredient ingredient, double boost) implements Recipe<NoInput> {
	...
	@Override public RecipeSerializer<? extends Recipe<NoInput>> getSerializer() { return ICRecipes.ANTIMATTER_BOOST_SERIALIZER.get(); }
	@Override public RecipeType<? extends Recipe<NoInput>> getType() {
		@SuppressWarnings("unchecked")
		RecipeType<? extends Recipe<NoInput>> t = (RecipeType<? extends Recipe<NoInput>>) (RecipeType<?>) ICRecipes.ANTIMATTER_BOOST.get();
		return t;
	}
