package dev.ftb.mods.industrialcontraptions.recipe;
...
public final class ICRecipes {
	public static final DeferredRegister<RecipeSerializer<?>> SERIALIZERS =
			DeferredRegister.create(Registries.RECIPE_SERIALIZER, IC.MOD_ID);

	public static final DeferredRegister<RecipeType<?>> TYPES =
			DeferredRegister.create(Registries.RECIPE_TYPE, IC.MOD_ID);
	...
	public static final DeferredHolder<RecipeType<?>, RecipeType<?>> BASIC_GENERATOR_FUEL = TYPES.register("basic_generator_fuel",
			() -> new RecipeType<>() { @Override public String toString() { return "ic:basic_generator_fuel"; } });
	...
	public static final DeferredHolder<RecipeType<?>, RecipeType<?>> ANTIMATTER_BOOST = TYPES.register("antimatter_boost",
			() -> new RecipeType<>() { @Override public String toString() { return "ic:antimatter_boost"; } });
