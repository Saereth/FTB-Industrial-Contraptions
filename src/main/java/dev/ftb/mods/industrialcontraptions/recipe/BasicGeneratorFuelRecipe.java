...
public record BasicGeneratorFuelRecipe(Ingredient ingredient, int ticks) implements Recipe<NoInput> {
	...
	@Override public RecipeSerializer<? extends Recipe<NoInput>> getSerializer() { return ICRecipes.BASIC_GENERATOR_FUEL_SERIALIZER.get(); }
	@Override public RecipeType<? extends Recipe<NoInput>> getType() {
		@SuppressWarnings("unchecked")
		RecipeType<? extends Recipe<NoInput>> t = (RecipeType<? extends Recipe<NoInput>>) (RecipeType<?>) ICRecipes.BASIC_GENERATOR_FUEL.get();
		return t;
	}
