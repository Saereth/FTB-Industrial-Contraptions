...
import dev.ftb.mods.industrialcontraptions.screen.QuarryMenu;
...
public class QuarryBlockEntity extends DiggingBaseBlockEntity {
	...
	public QuarryBlockEntity(BlockPos pos, BlockState state) {
		super(ICElectricBlocks.QUARRY, pos, state);
	}
	...
	public void digBlock(BlockState state, BlockPos miningPos) {
		...
		if (!tool.isEmpty() && tool.is(ItemTags.PICKAXES)
				&& ICConfig.MACHINES.QUARRY_PICKAXE_TAKES_DAMAGE.get() && tool.isDamageableItem()) {
