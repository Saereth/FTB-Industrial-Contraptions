...
import dev.ftb.mods.industrialcontraptions.screen.GeothermalGeneratorMenu;
...
public class GeothermalGeneratorBlockEntity extends GeneratorBlockEntity {
	...
	public GeothermalGeneratorBlockEntity(BlockPos pos, BlockState state) {
		super(ICElectricBlocks.GEOTHERMAL_GENERATOR, pos, state);
	}
	...
	public int getTankCapacity() {
		return ICConfig.MACHINES.GEOTHERMAL_GENERATOR_TANK_SIZE.get();
	}
