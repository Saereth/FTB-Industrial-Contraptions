...
import dev.ftb.mods.industrialcontraptions.item.DummyEnergyArmorItem;
import dev.ftb.mods.industrialcontraptions.item.EnergyArmorItem;
import dev.ftb.mods.industrialcontraptions.item.MechanicalElytraItem;
...
public final class EnergyArmorDamageHandler {
	...
	public static void onLivingDamage(LivingDamageEvent.Pre event) {
		...
		double energyCost = ICConfig.EQUIPMENT.ARMOR_DAMAGE_ENERGY.get() * absorbed;
	...
	public static void onFlyIntoWall(LivingDamageEvent.Pre event) {
		...
		double cost = ICConfig.EQUIPMENT.ARMOR_DAMAGE_ENERGY.get() * incoming;
