...
import dev.ftb.mods.industrialcontraptions.net.SelectCraftingRecipePayload;
import dev.ftb.mods.industrialcontraptions.screen.ICMenus;
import dev.ftb.mods.industrialcontraptions.screen.PoweredCraftingTableMenu;
...
public class PoweredCraftingTableTransferHandler implements IRecipeTransferHandler<PoweredCraftingTableMenu, RecipeHolder<CraftingRecipe>> {
	...
	public Optional<MenuType<PoweredCraftingTableMenu>> getMenuType() {
		return Optional.of(ICMenus.POWERED_CRAFTING_TABLE.get());
	}
