...
public class FTBICLanguageProvider extends LanguageProvider {
	...
	protected void addTranslations() {
		...
		add("ftbic.locks.locked", "Locked to %s. Use L to configure.");
		add("ftbic.locks.assign_hint", "Click: use cursor item or slot contents");
