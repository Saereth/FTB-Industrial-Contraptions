...
final class BatchFeederGameTests {
	...
	static void mixedFluids(GameTestHelper h) {
		...
		feeder.inputItems[0] = new ItemStack(Items.COPPER_INGOT, 6);
		feeder.setBufferFluid(new FluidStack(Fluids.WATER, 2_000));
		feeder.setBatchFluid(new FluidStack(Fluids.WATER, 1_000));
		...
		target.setFluids(new FluidStack(Fluids.WATER, 15_500), FluidStack.EMPTY);
		...
		FluidStack named = new FluidStack(Fluids.WATER, 1_000);
		named.set(DataComponents.CUSTOM_NAME, Component.literal("Batch water"));
