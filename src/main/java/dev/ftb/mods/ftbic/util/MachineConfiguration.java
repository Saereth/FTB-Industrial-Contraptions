...
public record MachineConfiguration(Identifier machine, SideConfiguration sides, List<GhostItem> inputLocks, List<GhostItem> batch, SimpleFluidContent batchFluid, QuarryFilter quarryFilter) {
	...
	public MachineConfiguration(Identifier machine, SideConfiguration sides, List<GhostItem> inputLocks, List<GhostItem> batch, SimpleFluidContent batchFluid) {
	...
	public static final Codec<MachineConfiguration> CODEC = RecordCodecBuilder.create(i -> i.group(
			...
			QuarryFilter.CODEC.optionalFieldOf("quarry_filter", QuarryFilter.DEFAULT).forGetter(MachineConfiguration::quarryFilter)
