...
public interface FTBICItems {
	...
	DeferredItem<Item> CONFIGURATION_CARD = REGISTRY.register("configuration_card", name -> new ConfigurationCardItem(props(name)));
	...
	DeferredItem<Item> QUARRY_FILTER_UPGRADE = REGISTRY.register("quarry_filter_upgrade", name -> new UpgradeItem(props(name), 32));
